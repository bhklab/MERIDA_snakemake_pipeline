...
miniconda3 using the instructions available here: https://docs.conda.io/en/latest/miniconda.html. If you do not currently have R installed, you can install it via conda using the command: `conda -c conda-forge r-base==4.1`.
...
software packages it depends on. We have included the `envs/merida.yaml` and `renv.lock` files here to easily accomplish this.
